...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}){const {slug}=await params;const a=articles.find(a=>a.slug===slug);return {title:a?`${a.title} — The Quant Journal`:"Article not found",description:a?.dek};}
